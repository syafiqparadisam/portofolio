const TechService = ({
	...
	return (
		<div className="tablet:w-1/4 hp:w-1/3 w-full hp:m-0 mx-5 bg-white flex flex-wrap tablet:justify-start justify-center flex-col items-center tablet:items-start shadow-xl mx-auto rounded-lg p-4 border-solid hover:bg-gray-300">
